export default {
  ...
  updates: {
    ...
    rateLimited:
      "Le verifiche degli aggiornamenti di GitHub sono temporaneamente limitate. Puoi comunque aprire la pagina delle release per verificare manualmente.",
    openRelease: "Apri Release",
    downloadAndInstall: "Scarica e Installa",
    portableManualUpdate:
      "Le build portatili non possono utilizzare l'installer in-app. Scarica lo ZIP portatile dalla pagina delle release, quindi estrailo nella cartella DBX corrente per mantenere portable.dbx e i dati.",
  ...
  connection: {
    ...
    sqliteExtensionsHint:
      "Una .dylib/.so/.dll per riga. Usa “percorso|punto di ingresso” quando è richiesto un punto di ingresso. Caricata alla connessione, poi load_extension viene disabilitata.",
    ...
    mysqlCaCertHint:
      "Richiesto per Verifica CA e Verifica Identità quando il certificato del server usa una CA privata.",
    ...
    mysqlClientCertHint:
      "Il certificato client e la chiave privata devono essere forniti insieme quando MySQL richiede mTLS.",
    ...
    postgresRootCertHint:
      "Usa questo per verifica-ca o verifica-completa quando il certificato del server è firmato da una CA privata.",
    ...
    postgresClientCertHint:
      "Il certificato client e la chiave privata devono essere forniti insieme quando PostgreSQL richiede mTLS.",
    ...
    systemJavaNotFound:
      "Runtime Java di sistema non trovato in PATH. Installa Java o scegli un eseguibile Java personalizzato.",
    ...
    sshHopInvalidAuth: "{hop}: password o percorso chiave richiesti",
    ...
    jdbcDriverClassPlaceholder:
      "La maggior parte dei driver si registra automaticamente; usa com.vendor.jdbc.Driver si necessario",
  ...
  grid: {
    ...
    formatterCustomTemplateHint:
      "Variabili disponibili: ${value}, ${upper}, ${lower}, ${length}. Assegna un nome per salvarlo nell'elenco.",
    ...
    truncatedHint:
      "Risultati troncati a {count} righe. Usa la paginazione a piè di pagina o regola le righe per pagina.",
  },
  exportProgress: {
  ...
  lineage: {
    ...
    description: {
      foreignKeyIncoming:
        "{target} punta al campo corrente tramite una chiave esterna. Si tratta di una dipendenza verificata.",
      foreignKeyOutgoing:
        "Il campo corrente fa riferimento a {target} tramite una chiave esterna. Si tratta di una dipendenza verificata.",
      viewLikely:
        "La definizione della vista menziona sia la tabella che il campo di destinazione, indicando solitamente una dipendenza della query.",
      viewPossible:
        "La definizione della vista menziona un campo con lo stesso nome ma non la tabella di destinazione, pertanto richiede conferma.",
      historyLikely:
        "Un'istruzione SQL della cronologia menziona sia la tabella che il campo di destinazione. Utilizzalo come contesto per l'analisi dell'impatto.",
      historyPossible:
        "Un'istruzione SQL della cronologia menziona un campo con lo stesso nome. Potrebbe essere correlata, ma necessita di contesto.",
      sameName:
        "Un'altra tabella ha un campo con lo stesso nome. Potrebbe condividere il significato aziendale ma non è una dipendenza verificata del database.",
    },
    cancel: "Annulla",
  ...
  connectionGroup: {
    ...
    deleteGroupConfirmMessage:
      'Eliminare il gruppo "{name}"? Le connessioni al suo interno verranno spostate al livello principale.',
  },
  databaseSearch: {
  ...
  configExport: {
    ...
    passphraseExportHint:
      "Per includere le password di connessione nell'esportazione, imposta una passphrase per la crittografia. Avrai bisogno della stessa passphrase per importare.",
  ...
  contextMenu: {
    ...
    structureDocCopyFallbackHint:
      "La copia automatica è stata bloccata. Fai di nuovo clic su Copia o seleziona il contenuto di seguito.",
    ...
    confirmDropTableMessage:
      'Sei sicuro di voler eliminare (DROP) la tabella "{name}"? Questa operazione eliminerà permanentemente la tabella e tutti i suoi dati.',
    ...
    confirmTruncateTableMessage:
      'Sei sicuro di voler troncare (TRUNCATE) la tabella "{name}"? Questa operazione rimuoverà tutte le righe.',
    ...
    confirmExecuteProcedureMessage:
      'Eseguire la procedura "{name}"? È possibile compilare o regolare i valori dei parametri prima.',
    loadingProcedureParameters: "Caricamento parametri...",
    procedureParametersUnavailable:
      "Impossibile caricare i metadati dei parametri. Puoi comunque modificare l'SQL di seguito ed eseguirlo.",
    ...
    parameterDefaultHint:
      "Quando DEFAULT è selezionato, DBX omette quell'argomento in modo che il database utilizzi il valore predefinito della procedura.",
    ...
    confirmBatchDropMessage:
      "Sei sicuro di voler eliminare {count} oggetti selezionati? Questa azione non può essere annullata.",
    ...
    confirmDropDatabaseMessage:
      'Sei sicuro di voler eliminare il database "{name}"? Questa operazione eliminerà permanentemente il database e tutti i suoi dati.',
    ...
    confirmDropSchemaMessage:
      'Sei sicuro di voler eliminare lo schema "{name}"? Questa operazione eliminerà permanentemente lo schema e tutti i suoi oggetti.',
  ...
  objects: {
    ...
    confirmBatchDropMessage:
      "Sei sicuro di voler eliminare {count} tabelle selezionate? Questa azione non può essere annullata.",
  ...
  history: {
    ...
    aiAnalyzeNoConnection:
      "Impossibile analizzare questa voce della cronologia poiché la sua connessione non esiste più.",
  ...
  dangerDialog: {
    ...
    message:
      "Questa istruzione SQL potrebbe modificare o eliminare i dati in modo irreversibile. Sei sicuro di volerla eseguire?",
    ...
    deleteRowMessage:
      "Questa riga verrà contrassegnata per l'eliminazione e rimossa dal database dopo il salvataggio. Continuare?",
    deleteRowsMessage:
      "Queste {count} righe verranno contrassegnate per l'eliminazione e rimosse dal database dopo il salvataggio. Continuare?",
  ...
  dataCompare: {
    ...
    selectSourceTables:
      "Seleziona prima la connessione e il database sorgente, quindi scegli le tabelle da confrontare",
    ...
    keyColumnsAutoHint:
      "Lascia vuoto per rilevare automaticamente le chiavi primarie per il confronto a tabella singola, o per tabella nel confronto batch.",
    ...
    planSummary:
      "Piano: {inserts} inserimenti, {updates} aggiornamenti, {deletes} eliminazioni, {statements} istruzioni",
    statusDifferent: "Diverse",
    statusSame: "Identiche",
    statusError: "Non riuscite",
    noKeyColumns: "Seleziona almeno una colonna chiave",
    missingKeyColumns:
      "Le colonne chiave devono esistere sia nella tabella sorgente che in quella di destinazione: {columns}",
    ...
    noComparableTables:
      "Nessuna tabella confrontabile trovata. Verifica se esistono tabelle di destinazione con lo stesso nome.",
  ...
  settings: {
    ...
    uiScale: "Scala UI",
    uiScaleDescription:
      "Scala l'intera interfaccia utente desktop per display ad alta densità (High-DPI). Le modifiche si applicano immediatamente e vengono ripristinate al prossimo avvio.",
    theme: "Tema",
    ...
    sidebarObjectDisplayGroupedDescription:
      "Raggruppa gli oggetti per tabelle, viste, procedure e funzioni per i database con più tipi di oggetti.",
    sidebarObjectDisplaySimple: "Vista semplice",
    sidebarObjectDisplaySimpleDescription:
      "Elenca tabelle e viste direttamente sotto ogni database o schema per ridurre i livelli intermedi.",
    autoSelectActiveSidebarNode: "Seleziona sempre l'elemento aperto",
    autoSelectActiveSidebarNodeDescription:
      "Quando passi da una scheda all'altra, seleziona la tabella, la collezione o il file SQL visibile corrispondente nella barra laterale.",
    disconnectTabHandlingMode: "Schede dopo la disconnessione",
    disconnectTabHandlingModeDescription:
      "Scegli come gestire le schede correlate dopo la chiusura di una connessione o di un database.",
    ...
    disconnectTabHandlingModeKeepTabsClearResultsDescription:
      "Chiudi i dati delle tabelle, l'esplorazione degli oggetti e le schede della struttura mantenendo le schede delle query SQL e il testo SQL, e cancella anche lo stato di esecuzione e le sessioni dei risultati.",
    ...
    disconnectTabHandlingModeKeepTabsKeepResultsDescription:
      "Mantieni le schede correlate, il testo SQL e i risultati correnti senza ulteriore pulizia.",
    reuseDataTab: "Riusa scheda dati",
    reuseDataTabDescription:
      "Quando fai clic su una tabella nella barra laterale, riutilizza la scheda dati esistente invece di crearne una nuova ogni volta.",
    sidebarHiddenTablePrefixes: "Prefissi dei nomi delle tabelle nascosti",
    sidebarHiddenTablePrefixesDescription:
      "Un prefisso per riga. Solo le etichette di tabelle, viste e collezioni della barra laterale vengono abbreviate; i suggerimenti e le azioni utilizzano ancora il nome completo.",
    ...
    sidebarHideTableCommentsDescription:
      "Nascondi i commenti in linea delle tabelle/viste mostrati accanto ai nomi nell'albero della barra laterale per risparmiare spazio orizzontale.",
    sidebarAllowHorizontalScroll: "Consenti scorrimento orizzontale barra laterale",
    sidebarAllowHorizontalScrollDescription:
      "Mostra i nomi lunghi di tabelle, viste e collezioni per intero consentendo lo scorrimento orizzontale della barra laterale.",
    ...
    syncRememberWebDavPasswordDescription:
      "La password viene crittografata e memorizzata solo su questo dispositivo. Non viene sincronizzata su WebDAV e non sostituisce la password di sincronizzazione.",
    ...
    syncSecretNotice:
      "Per impostazione predefinita, DBX sincronizza solo i dettagli e le impostazioni di connessione. Le password dei database, le password SSH, le password proxy, le stringhe di connessione e le chiavi API AI rimangono locali.",
    syncSecrets: "Sincronizza i segreti crittografati",
    syncSecretsDescription:
      "Se abilitato, DBX crittografa le password del database, le password SSH e le chiavi API AI prima di caricarle su WebDAV.",
    syncSecretsPassphrase: "Password di sincronizzazione",
    syncSecretsPassphraseDescription:
      "Questa password viene utilizzata solo per crittografare e ripristinare i dati sensibili. DBX non la salva; inseriscila nuovamente su ciascun dispositivo.",
    syncTest: "Verifica",
    syncUpload: "Carica",
    ...
    syncDownloadConfirm:
      "Scaricare e applicare lo snapshot DBX remoto? I metadati locali e i file SQL salvati verranno sostituiti.",
    apply: "Applica",
    ...
    exportBatchSizeDescription:
      "Righe recuperate per lotto durante l'esportazione dei dati della tabella (100-100000).",
    ...
    mcpTitle: "Server MCP",
    mcpDescription:
      "Verifica l'installazione e la versione del Server DBX MCP utilizzata da Claude Code, Cursor e altri agenti.",
    ...
    mcpReadonlyModeDescription:
      "Aggiunge DBX_MCP_ALLOW_WRITES=0 alla configurazione di esempio in modo che la sessione MCP rimanga di sola query.",
    mcpAllowDangerous: "Consenti SQL pericoloso",
    mcpAllowDangerousDescription:
      "Aggiunge DBX_MCP_ALLOW_DANGEROUS_SQL=1 alla configurazione di esempio in modo che siano consentite istruzioni come DROP, TRUNCATE, ALTER e simili.",
    mcpDetectionTiming:
      "DBX esegue la verifica automaticamente all'apertura di questa pagina; usa di nuovo Verifica per aggiornare.",
    mcpNpmBoundary:
      "DBX verifica e spiega solo lo stato di MCP; l'installazione e gli aggiornamenti vengono comunque eseguiti tramite npm.",
